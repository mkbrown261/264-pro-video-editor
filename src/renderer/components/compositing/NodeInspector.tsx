...
const PARAM_GROUPS: Record<string, { label: string; keys: string[] }[]> = {
  ...
  // Creator Node Pack
  Duotone: [{ label: "Duotone", keys: ["shadowColor", "highlightColor"] }],
  RGBShift: [{ label: "RGB Shift", keys: ["amount"] }],
  ChromaShift: [{ label: "RGB Shift", keys: ["amount"] }],
  Glitch: [{ label: "Glitch", keys: ["intensity"] }],
  Scanlines: [{ label: "Scanlines", keys: ["intensity"] }],
  CRT: [{ label: "CRT", keys: [] }],
  Halftone: [{ label: "Halftone", keys: ["scale"] }],
  Pixelate: [{ label: "Pixelate", keys: ["size"] }],
  HDRToneMap: [{ label: "Tone Map", keys: ["exposure", "gamma"] }],
  ToneMap: [{ label: "Tone Map", keys: ["exposure", "gamma"] }],
  Solarize: [{ label: "Solarize", keys: ["threshold"] }],
  TealOrange: [{ label: "Teal & Orange", keys: ["strength"] }],
  CinematicLook: [{ label: "Teal & Orange", keys: ["strength"] }],
  FadedFilm: [{ label: "Faded Film", keys: ["strength"] }],
  FilmFade: [{ label: "Faded Film", keys: ["strength"] }],
  CrossProcess: [{ label: "Cross Process", keys: ["strength"] }],
  E6: [{ label: "Cross Process", keys: ["strength"] }],
