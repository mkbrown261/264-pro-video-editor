...
const ADD_NODE_CATEGORIES: { category: CompNodeCategory; types: CompNodeType[] }[] = [
  ...
  },
  {
    ...
    types: ["FilmGrain", "ChromaticAberration", "Vignette", "Lens Flare", "Glow", "Emboss", "EdgeDetect",
          "Duotone", "RGBShift", "Glitch", "Scanlines", "CRT", "Halftone", "Pixelate",
          "HDRToneMap", "Solarize", "TealOrange", "FadedFilm", "CrossProcess"],
  },
  {
    category: "Keying",
...
const NODE_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  "Duotone":          "Maps shadows and highlights to two custom colors for stylised looks.",
  "RGBShift":         "Splits R/G/B channels horizontally for chromatic glitch effect.",
  "ChromaShift":      "Alias for RGBShift.",
  "Glitch":           "Digital glitch effect with horizontal slice distortion.",
  "Scanlines":        "CRT-style horizontal scanline overlay.",
  "CRT":              "Curved CRT screen simulation with barrel distortion + scanlines.",
  "Halftone":         "B&W halftone dot-pattern effect.",
  "Pixelate":         "Mosaic / pixelate effect.",
  "HDRToneMap":       "ACES HDR tone mapping curve with exposure and gamma control.",
  "ToneMap":          "Alias for HDRToneMap.",
  "Solarize":         "Inverts pixels above a luminance threshold (darkroom solarize).",
  "TealOrange":       "Hollywood cinematic teal-shadow / orange-highlight grade.",
  "CinematicLook":    "Alias for TealOrange.",
  "FadedFilm":        "Analog film look: lifted blacks, desaturated, warm cast.",
  "FilmFade":         "Alias for FadedFilm.",
  "CrossProcess":     "E-6 film cross-processed in C-41 chemistry look.",
